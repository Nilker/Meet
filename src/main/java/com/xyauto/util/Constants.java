...
public interface Constants {
	...
	// public static final String GET_OA_CHECK =
	// "http://oa1.xingyuanauto.com/hrwebapi/Authorize/Check";
	// public static final String GET_OA_USER =
	// "http://oa1.xingyuanauto.com/hrwebapi/EmployeeForPortal/GetEmpForPortal";
	// public static final String OA_LOGIN_URL =
	// "http://oa1.xingyuanauto.com/login.aspx";
