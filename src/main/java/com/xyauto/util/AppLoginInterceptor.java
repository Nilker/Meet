...
public class AppLoginInterceptor {
	...
	private static User getLoginUser(HttpServletRequest request)
		...
		HttpGet httpCheckGet = new HttpGet(PropertiesUtil.getPropertiesByKey("GET_OA_CHECK"));
		...
		HttpGet httpUserGet = new HttpGet(PropertiesUtil.getPropertiesByKey("GET_OA_USER"));
