...
import com.xyauto.util.CookieUtils;
...
public class LoginInterceptor extends HandlerInterceptorAdapter {
	...
	private User getLoginUser(HttpServletRequest request) throws InterruptedException, ExecutionException, ParseException, IOException{
		
		String cookieValue = CookieUtils.getCookieValue(request, Constants.COOKIE_KEY);
